...
int main(int argc, char **argv) {
  ...
  graphics = new brGraphics(width, height, fullscreen, bpp);
  graphics->loadImages(playersImg, itemsImg, skyImg, frontImg, postImg);
  //graphics->loadImages("imgs/players.bmp", "imgs/items.bmp", "imgs/sky.bmp", "imgs/front.bmp", "imgs/post.bmp");
  ...
  daysLeft = 0;
  //if (year == 2003 && month == 8 && day <= 31) daysLeft = 32-day+20;
  //if (year == 2003 && month == 9 && day <= 20) daysLeft = 21-day;
  //if (year == 2003 && month == 9 && day <= 30) daysLeft = 31-day+10;
  //if (year == 2003 && month == 10 && day <= 10) daysLeft = 10-day;
  //if (year == 2003 && month == 10 && day <= 31) daysLeft = 32-day;
  //if (year == 2003 && month == 11 && day <= 30) daysLeft = 31-day;
  //if (year == 2003 && month == 12 && day <= 31) daysLeft = 32-day;
  //if (year == 2004 && month == 1 && day <= 31) daysLeft = 32-day;
  //if (year == 2004 && month == 2) daysLeft = 29-day + 31;
  //if (year == 2004 && month == 3) daysLeft = 32-day;
  //if (year == 2004 && month == 4) daysLeft = 31-day + 31;
  //if (year == 2004 && month == 5) daysLeft = 32-day;
  //if (year == 2004 && month == 6) daysLeft = 31-day + 31;
  //if (year == 2004 && month == 7) daysLeft = 32-day;
  //if (year == 2004 && month == 8) daysLeft = 32-day;
  //if (year == 2004 && month == 9) daysLeft = 31-day;
  daysLeft = 100;
  if (daysLeft <= 0) {
...
void loadConfig(char *filename) {
  ...
  while (!feof(fp)) {
    ...
    if (!strcmp(key, "maxfps")) {
      fscanf(fp, "%s", val);
      maxfps = atoi(val);
    }
    if (!strcmp(key, "animfps")) {
      fscanf(fp, "%s", val);
      animdelay = 1000/atoi(val);
    }
    if (!strcmp(key, "bpp")) {
      fscanf(fp, "%s", val);
      bpp = atoi(val);
