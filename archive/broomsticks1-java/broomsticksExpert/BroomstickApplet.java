...
public class BroomstickApplet extends Applet implements Runnable {
  ...
  public void init() {
    System.out.println("\n");
    System.out.println("----==== Broomsticks 1.28 by Paul Rajlich ====----");
    System.out.println("   copyright (c) 2000, 2001, all rights reserved\n");
  ...
  public void openUK() {
    try {
      URL vb = new URL("http://www.wizards-shop.co.uk/broomsticks/");
      this.getAppletContext().showDocument(vb, "newUK");
    } catch (MalformedURLException me) {
      System.out.println("MalformedURLException: " + me);
    }
  }
  ...
  public void drawScene(Graphics g) {
    if (!tracker.checkAll(true)) {
      ...
      g.drawString("Copyright (c) 2001 Paul Rajlich, all rights reserved.", 190, 365);
      ...
      if (!gameover) {
        ...
        if (!player1.isRobot) {
          ...
          g.drawString("use E, S, F, X keys", 100, 260);
        ...
        g.drawString("510 Cedar Drive", 100, 270);
  ...
  public void paint(Graphics g) {
    ...
    drawScene(g);
    drawScores(g);
    g.drawString("Broomsticks Expert by Paul Rajlich", 225, 20);
    ...
    if (started) {
      if (player1.isRobot) {
        ...
        g.drawString("E S F X and 1", 50, 415);
  ...
  public void checkCaught() {
    ...
    int dx = (int) (p1.x+8 - rb.x);
    int dy = (int) (p1.y+8 - rb.y);
...
class Person extends FlyingObject {
  ...
  public void draw(Graphics g) {
    ...
    if (side == 0) {
      ...
      //else
      g.drawImage(applet.img[model][v][h], (int) x, (int) y, applet);
    }
    else
      g.drawImage(applet.img[model+5][v][h], (int) x, (int) y, applet);
  }
}
...
class Ball extends FlyingObject {
  ...
  public void draw(Graphics g) {
    g.drawImage(applet.ballImg[model], (int) x, (int) y, applet);
  }
}
