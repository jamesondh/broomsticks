...
public class BroomstickApplet extends Applet implements Runnable {
  ...
  public void drawScene(Graphics g) {
    if (!tracker.checkAll(true)) {
      ...
      g.drawString("Zvolte hru s", 170, 225);
      //g.drawString("single player", 170, 240);
      g.drawString("jedním hráèem", 170, 240);
      //g.drawString("Click here for", 420, 225);
      g.drawString("Zvolte hru se", 420, 225);
      //g.drawString("two player", 420, 240);
      g.drawString("dvìma hráèi", 420, 240);
      g.setColor(green);
      ...
      g.drawImage(introImg, 150, 70, this); // was 160
        ...
        g.drawString("Zde pokraèujte", 260, 180);

        //g.drawString("The rules of the game are:", 150, 240);
        g.drawString("Pravidla hry:", 150, 240);
        g.drawString("1. Pokud se hráèi støetnou, hráè, který je ní~^ je sra~^en na zem.", 150, 260);
        g.drawString("2. Pokud se hráè støetne s èerným míèem, je sra~^en na zem.", 150, 275);
        g.drawString("3. Hráè získá èervený míè, kdy~^ se dostane do jeho blízkosti.", 150, 290);
        g.drawString("4. Hráè získá 10 bodù, umísti-li èervený míè do protihráèova ko~Ze.", 150, 305);
        g.drawString("5. Zvítìzí hráè, který první získá 50 bodù.", 150, 320);
      ...
      if (!gameover) {
        ...
        g.drawString("Zaènìte hrát", 275, 180);
